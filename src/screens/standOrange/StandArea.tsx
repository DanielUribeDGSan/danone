...
import 'animate.css';
import StandImage from '../../../src/assets/img/stand/DanoneFlexitarianismo.png';
...
export const StandArea = () => {
  ...
  return (
    <>
      ...
      <div className='stand-area-orange'>
        <div className='stand-content'>
          ...
          />
          <Link to={'/microbiota-y-probioticos'} className='btn-left'>
            <ArrowBackIosNewIcon />
          </Link>
          <Link to={'/nutricion-personalizada'} className='btn-right'>
            <ArrowForwardIosIcon />
          </Link>
